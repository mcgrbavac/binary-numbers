...
if answer_1 == "y":
	...
	if answer_3 == "y":
		...
		stringPrint = "Input a binary number between 1 and {}: ".format(y)
		x = input(stringPrint).strip()
		z = binary_to_decimal(x)
		z = int(z)
		if z > numberOfWords or z < 1:
			print("You did not - " + stringPrint)
		else:
			output1 = wordList[z-1].strip()
			output2 = str(z)
			output3 =  x
		...
		if answer_4 == "y":
			stringPrint = "Input a decimal number between 1 and {}: ".format(numberOfWords)
